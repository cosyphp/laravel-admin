            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ config('alioss.OSS_HOST').'/'.Admin::user()->avatar }}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{{ config('alioss.OSS_HOST').'/'.Admin::user()->avatar }}" class="img-circle" alt="User Image">
